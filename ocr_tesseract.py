...
if __name__ == "__main__":
    ...
    for t in listfile:
        ...
        print("Correct text has a length =", text, "| OCR text has a length =", ocr)

        answer_list = [correct_text]
        easy_list = [tocr]
        ...
        file = f'tesseract_ocr_report/{t[0].split(".")[0]}.json'
        with open(file, 'w', encoding='utf-8') as f:
            f.write(df_easy_wrong_diff.to_json(orient='records', force_ascii=False, indent=4))
        print("\n","-"*50,"\n")
